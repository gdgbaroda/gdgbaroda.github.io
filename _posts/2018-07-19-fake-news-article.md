...
<center>**GREAT NEWS!! OR FAKE NEWS??!!**</center>![Think]({{page.assets}}/think.jpg){:class="img-responsive" : .center-image }
...
![Fake news in old days]({{page.assets}}/fake news in old days.jpg){:class="img-responsive" : .center-image }
...
![Clickbait News]({{page.assets}}/clickbait_news.png){:class="img-responsive" : .center-image }
...
![Propaganda News]({{page.assets}}/propaganda_news.png){:class="img-responsive" : .center-image }
...
![Satirical News]({{page.assets}}/satirical_news.png){:class="img-responsive" : .center-image }
...
![Slanted News]({{page.assets}}/slanted_news.png){:class="img-responsive" : .center-image }      
...
![Whatsapp Ad]({{page.assets}}/whatsapp ad.jpg){:class="img-responsive" : .center-image }
